...
const FREE_MODELS = [{id:"corethink:free",name:"CoreThink (free)",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:78000,maxTokens:8192},{id:"minimax/minimax-m2.5:free",name:"MiniMax M2.5 (free)",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:204800,maxTokens:131072},{id:"z-ai/glm-5:free",name:"GLM 5 (free)",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:202800,maxTokens:131072},{id:"giga-potato",name:"Giga Potato (free)",reasoning:false,input:["text","image"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:256000,maxTokens:32000},{id:"arcee-ai/trinity-large-preview:free",name:"Trinity Large Preview (free)",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:131000,maxTokens:8192},{id:"x-ai/grok-code-fast-1:optimized:free",name:"Grok Code Fast 1 Optimized (free)",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:256000,maxTokens:10000},{id:"openrouter/aurora-alpha",name:"Aurora Alpha (free)",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:128000,maxTokens:50000},{id:"openrouter/free",name:"OpenRouter Free Models",reasoning:false,input:["text","image"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:200000,maxTokens:8192},{id:"stepfun/step-3.5-flash:free",name:"Step 3.5 Flash (free)",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:256000,maxTokens:256000}];
