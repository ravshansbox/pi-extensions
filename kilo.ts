...
const FREE_MODELS = [{id:"corethink:free",name:"CoreThink",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:78000,maxTokens:8192},{id:"minimax/minimax-m2.5:free",name:"MiniMax M2.5",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:204800,maxTokens:131072},{id:"giga-potato",name:"Giga Potato",reasoning:false,input:["text","image"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:256000,maxTokens:32000},{id:"arcee-ai/trinity-large-preview:free",name:"Trinity Large Preview",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:131000,maxTokens:8192},{id:"x-ai/grok-code-fast-1:optimized:free",name:"Grok Code Fast 1 Optimized",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:256000,maxTokens:10000},{id:"openrouter/aurora-alpha",name:"Aurora Alpha",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:128000,maxTokens:50000},{id:"openrouter/free",name:"OpenRouter Models",reasoning:false,input:["text","image"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:200000,maxTokens:8192},{id:"stepfun/step-3.5-flash:free",name:"Step 3.5 Flash",reasoning:false,input:["text"],cost:{input:0,output:0,cacheRead:0,cacheWrite:0},contextWindow:256000,maxTokens:256000}];
