...
const PROVIDER = "openai-codex-multi";
const TITLE = "OpenAI Codex Multi";
const BASE_URL = "https://chatgpt.com/backend-api";
const API = "openai-codex-multi-api";
		...
		(async () => {
			...
			for (const index of order) {
				...
				const inner = streamSimple(
					{ ...model, api: "openai-codex-responses", provider: "openai-codex" } as any,
					context,
...
export default function (pi: ExtensionAPI) {
	...
	pi.registerCommand(PROVIDER, {
		description: "Manage OpenAI Codex multi-account provider",
